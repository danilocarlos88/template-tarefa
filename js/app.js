...
/**
    ...
    function Remodal($modal, options) {
        ...
        remodal.$closeButton = $("<div id='closesidesbtn'><a href='#'><img src='" + root_rel + "img/modal-close.png' alt='Fechar Modal'></a></div>").addClass(pluginName + "-close");
